      ...
      dark:border-gray-700 dark:hover:bg-gray-700">
        <div class="text-center">
          ...
          <div>
            ...
            <button type="button"
              class="focus:outline-none text-white bg-purple-700 hover:bg-purple-800 focus:ring-4 focus:ring-purple-300 font-medium rounded-lg text-sm px-6 py-1.5 mb-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900">Save</button>
          </div>
          <button type="button"
            class="focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-1.5 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
            @click="removePokemon(id)">
            Remover
          </button>
        </div>
      </div>
...
// function giveNickname(entry_number: number, name: string) {
//   let nickname = {
